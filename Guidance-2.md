...
- このように、データの特徴を見出しその扱いに慣れているエキスパートがデータサイエンティスト
...
一つだけにしてみても、やはり、中央が円で囲われた境界が現れている
