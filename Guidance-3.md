...
- 局所解が気になって、正しい答えに至っているのかわからない
  - モダンなDNNでは実は局所解は最小解とほぼ同じ性能(flat minima)
  - 高次元では「悪い局所解」がほとんど存在しない(measure-zero)
  - SGDの暗黙の正則化（Implicit Bias）により、幅が広く平らな最小値（flat minima）を選びやすく、狭い谷間には入りづらい
