...
次の図で、例えば、1つめのlinearは線形分離できるが、2つめのnon-linearは線形分離できない
...
## 第2次AIブーム
MLPの概念は1950〜60年代から存在していたが、多層パーセプトロンと誤差逆伝播による学習の実用化は1986年に確立
...
結果的に、多くの場面でディープラーニングが優位となり、従来の常識が通用しないケースが増えた
